    ...
    <body class="font-poppins antialiased">
        ...
        <div id="navigation" class="hidden lg:block fixed top-1/2 left-0 transform -translate-x-full -translate-y-1/2 w-56 h-[95vh] border border-gray-200 bg-white rounded-2xl p-5 xl:w-72 lg:translate-x-5 transition-all duration-300 dark:bg-[#132347] dark:border-[#132347]">
            ...
            <div class="flex flex-col gap-1">
                ...
                @endphp
                <a href="{{ route('dashboard') }}" class="{{ $dashboard ? 'bg-indigo-100 dark:bg-indigo-900' : 'bg-transparent' }} flex items-center gap-5 py-4 px-3 rounded-lg hover:bg-indigo-100 transition-all duration-300 dark:hover:bg-indigo-900">
                ...
                <a href="{{ route('daftar.mahasiswa') }}" class="{{ $mahasiswa ? 'bg-indigo-100 dark:bg-indigo-900' : 'bg-transparent' }} flex items-center gap-5 py-4 px-3 rounded-lg hover:bg-indigo-100 transition-all duration-300 dark:hover:bg-indigo-900">
                ...
                <a href="{{ route('daftar.jurusan') }}" class="{{ $jurusan ? 'bg-indigo-100 dark:bg-indigo-900' : 'bg-transparent' }} flex items-center gap-5 py-4 px-3 rounded-lg hover:bg-indigo-100 transition-all duration-300 dark:hover:bg-indigo-900">
