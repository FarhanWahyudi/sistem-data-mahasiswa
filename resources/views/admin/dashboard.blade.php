...
<div class="flex flex-col gap-8 pb-10">
    ...
    <div class="grid grid-cols-4 gap-5">
        <div class="col-span-full flex justify-between items-start px-3 py-4 rounded-xl border border-gray-200 bg-white sm:col-span-2 xl:col-span-1">
            <div class="h-full flex flex-col justify-between">
                <h2 class="text-gray-500 font-medium">Total Mahasiswa</h2>
                <span class="text-3xl font-medium">12</span>
            </div>
        ...
        <div class="col-span-full flex justify-between items-start px-3 py-4 rounded-xl border border-gray-200 bg-white sm:col-span-2 xl:col-span-1">
            <div class="h-full flex flex-col justify-between">
                <h2 class="text-gray-500 font-medium">Mahasiswa Pria</h2>
        ...
        <div class="col-span-full flex justify-between items-start px-3 py-4 rounded-xl border border-gray-200 bg-white sm:col-span-2 xl:col-span-1">
            <div class="h-full flex flex-col justify-between">
                <h2 class="text-gray-500 font-medium">Mahasiswa Wanita</h2>
                <span class="text-3xl font-medium">8</span>
            </div>
        ...
        <div class="col-span-full flex justify-between items-start px-3 py-4 rounded-xl border border-gray-200 bg-white sm:col-span-2 xl:col-span-1">
            <div class="h-full flex flex-col justify-between">
                <h2 class="text-gray-500 font-medium">Total Jurusan</h2>
                <span class="text-3xl font-medium">5</span>
            </div>
    ...
    <div class="grid grid-cols-2 gap-8">
        <div class="col-span-full bg-white rounded-xl border border-gray-200 p-5 md:col-span-1 2xl:p-8">
            <h2 class="text-gray-500 font-medium">Total mahasiswa berdasarkan gender</h2>
            <div class="mt-5 xl:h-96">
                <canvas id="myChart"></canvas>
            </div>
        </div>
        <div class="col-span-full bg-white rounded-xl border border-gray-200 p-5 md:col-span-1 2xl:p-8">
            <h2 class="text-gray-500 font-medium">Total mahasiswa berdasarkan jurusan</h2>
            <div class="mt-5 xl:h-96">
    ...
    <div class="flex items-start gap-8 flex-wrap">
        <div class="w-full xl:w-[60%] bg-white rounded-xl border border-gray-200 p-5 overflow-x-auto 2xl:p-8">
            <h2 class="text-gray-500 font-medium">Daftar Mahasiswa</h2>
            <table class="w-[43rem] mt-5 sm:w-full">
                <thead>
                    <tr class="border-b border-gray-200 gap-x-10">
                ...
                <tbody>
                    <tr class="border-b border-gray-200">
                        <td class="px-3 text-sm py-4 text-gray-700">Farhan Wahyudi</td>
                        <td class="px-3 text-sm py-4 text-gray-700">8764936</td>
                        <td class="px-3 text-sm py-4 text-gray-700">31 Maret 2025</td>
                        <td class="px-3 text-sm py-4 text-gray-700">Pria</td>
                        <td class="px-3 text-sm py-4 text-gray-700">Teknik Informatika</td>
                    </tr>
                    <tr class="border-b border-gray-200">
                        <td class="px-3 text-sm py-4 text-gray-700">Farhan Wahyudi</td>
                        <td class="px-3 text-sm py-4 text-gray-700">8764936</td>
        ...
        <div class="w-full xl:flex-1 bg-white rounded-xl border border-gray-200 p-5 overflow-x-auto 2xl:p-8">
            <h2 class="text-gray-500 font-medium">Daftar Jurusan</h2>
            <table class="table-fixed w-full mt-5">
                ...
                <tbody>
                    <tr class="border-b border-gray-200">
                        <td class="text-sm px-3 py-4 text-gray-700">Teknik Informatika</td>
                        <td class="text-sm px-3 py-4 text-gray-700">20</td>
                    </tr>
                    <tr class="border-b border-gray-200">
                        <td class="text-sm px-3 py-4 text-gray-700">Teknik Informatika</td>
                        <td class="text-sm px-3 py-4 text-gray-700">20</td>
